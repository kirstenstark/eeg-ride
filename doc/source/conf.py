...
project = 'eeg-ride'
copyright = '2024, Kirsten Stark & Alexander Enge'
author = 'Kirsten Stark, Alexander Enge'
version = '.'.join(ride.__version__.split('.', 2)[:2])
release = ride.__version__
...
html_theme_options = {
    'path_to_docs': 'doc',
    'repository_url': 'https://github.com/kirstenstark/eeg-ride',
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(ride.__file__))
    ...
    return "https://github.com/kirstenstark/eeg-ride/blob/%s/%s" % (tag, filename)
